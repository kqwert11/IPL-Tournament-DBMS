...
-- Table Structure of `PLAYS_IN_A_TOURNAMENT`

DROP TABLE IF EXISTS `PLAYS_IN_A_TOURNAMENT`;
CREATE TABLE `PLAYS_IN_A_TOURNAMENT` (
	`TID1` int(3) NOT NULL,
	`TID2` int(3) NOT NULL,
	`TeamID` int(3) NOT NULL,
	`VenueID` int(3) NOT NULL,
	`PID` int(3) NOT NULL,
	PRIMARY KEY (`TID1`,`TID2`,`PID`),
	CHECK( TeamID = TID1 OR TeamID = TID2),
	FOREIGN KEY (`TeamID`) REFERENCES `TEAMS` (`TeamID`) ON DELETE CASCADE,
	FOREIGN KEY (`TID1`) REFERENCES `TEAMS` (`TeamID`) ON DELETE CASCADE,
	FOREIGN KEY (`TID2`) REFERENCES `TEAMS` (`TeamID`) ON DELETE CASCADE,
	FOREIGN KEY (`VenueID`) REFERENCES `VENUE` (`VID`) ON DELETE CASCADE,
...
INSERT INTO `TEAMS` VALUES (110, 'Shastri', 001);
INSERT INTO `TEAMS` VALUES (120, 'Lehmann', 002);
INSERT INTO `TEAMS` VALUES (130, 'Mbangwa', 003);
INSERT INTO `TEAMS` VALUES (140, 'Arathapattu', 004);
INSERT INTO `TEAMS` VALUES (150, 'Trescothic', 005);
...
INSERT INTO `VENUE` VALUES (20, 'Hyderabad');
INSERT INTO `VENUE` VALUES (21, 'Sharjah');
INSERT INTO `VENUE` VALUES (75, 'Eden Gardens');
INSERT INTO `VENUE` VALUES (76, 'Melbourne');
INSERT INTO `VENUE` VALUES (22, 'Mumbai');
...
INSERT INTO `MATCHES` VALUES (110, 120, 110, 111, 'Bowden', 01, 20);
INSERT INTO `MATCHES` VALUES (130, 150, 150, 152, 'Billy', 02, 75);
INSERT INTO `MATCHES` VALUES (120, 140, 120, 121, 'Ravi', 02, 76);
INSERT INTO `MATCHES` VALUES (110, 130, 110, 112, 'Eric', 03, 20);
INSERT INTO `MATCHES` VALUES (140, 150, 140, 141, 'Bowden', 03, 21);
INSERT INTO `MATCHES` VALUES (140, 130, 130, 131, 'Bowden', 04, 20);
INSERT INTO `MATCHES` VALUES (150, 120, NULL, NULL, 'Tauffel', 04, 76);
INSERT INTO `MATCHES` VALUES (140, 150, NULL, NULL, 'Tauffel', 05, 76);
INSERT INTO `MATCHES` VALUES (130, 110, NULL, NULL, 'Bowden', 06, 75);
...
INSERT INTO `PLAYERS` VALUES (111, 'Sachin', 'Tendulkar', 47, 10, 'Blue', 110, 111);
INSERT INTO `PLAYERS` VALUES (112, 'Kushagra', 'Agarwal', 19, 07, 'Blue', 110, 111);
INSERT INTO `PLAYERS` VALUES (113, 'Virat', 'Kohli', 30, 18, 'Blue', 110, 111);
INSERT INTO `PLAYERS` VALUES (114, 'Rohit', 'Sharma', 36, 19, 'Blue', 110, 111);
INSERT INTO `PLAYERS` VALUES (121, 'Steve', 'Smith', 28, 09, 'Yellow', 120, 121);
INSERT INTO `PLAYERS` VALUES (122, 'David', 'Warner', 34, 06, 'Yellow', 120, 121);
INSERT INTO `PLAYERS` VALUES (131, 'Sid', 'Vij', 20, 99, 'Green', 130, 131);
INSERT INTO `PLAYERS` VALUES (132, 'Tanvi','Kamble', 30, 11, 'Green', 130, 131);
INSERT INTO `PLAYERS` VALUES (141, 'Akshit', 'Garg', 20, 02, 'White', 140, 142);
INSERT INTO `PLAYERS` VALUES (142, 'Shantanu', 'Agrawal', 19, 04, 'White', 140, 142);
INSERT INTO `PLAYERS` VALUES (151, 'Tanvi', 'Karandikar', 35, 86, 'Green', 150, 152);
INSERT INTO `PLAYERS` VALUES (152, 'Shreeya', 'Pahune', 18, 07, 'Green', 150, 152);
